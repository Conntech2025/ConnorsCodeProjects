...
def enter_data():
    ...
    if accepted == "Accepted":
        ...
        if firstname and lastname:
            ...
            age = int(age_spinbox.get())  # Convert age to integer
            nationality = nationality_combobox.get()

            # Course info
            registration_status = reg_status_var.get()
            numcourses = int(numcourses_spinbox.get())  # Convert to integer
            numsemesters = int(numsemesters_spinbox.get())  # Convert to integer
            ...
            filepath = "C:/Users/stoic/OneDrive/Desktop/openpyxl/data.xlsx"
