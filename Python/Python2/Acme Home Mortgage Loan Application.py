...
# Title Label
title_label = tk.Label(root, text="Acme Home Mortgage Loan Application", font=("Arial", 14, "bold"))
...
tk.Label(root, text="Last Name:").grid(row=1, column=2, sticky="e", padx=5, pady=5)
...
tk.Label(root, text="Phone:").grid(row=2, column=2, sticky="e", padx=5, pady=5)
entry_phone = tk.Entry(root, width=25)
entry_phone.grid(row=2, column=3, sticky="w")

# Loan Amount & Loan Term
tk.Label(root, text="Loan Amount:").grid(row=3, column=0, sticky="e", padx=5, pady=5)
entry_loan_amount = tk.Entry(root, width=25)
entry_loan_amount.grid(row=3, column=1, sticky="w")

tk.Label(root, text="Loan Term:").grid(row=3, column=2, sticky="e", padx=5, pady=5)
...
# Employment Status
tk.Label(root, text="Employment Status:").grid(row=4, column=0, sticky="e", padx=5, pady=5)
...
# Annual Income
tk.Label(root, text="Annual Income:").grid(row=5, column=0, sticky="e", padx=5, pady=5)
entry_income = tk.Entry(root, width=25)
entry_income.grid(row=5, column=1, sticky="w")

# Submit Button (Centered)
submit_button = tk.Button(root, text="Submit Application", command=save_data, bg="green", fg="white", font=("Arial", 12, "bold"))
