...
def run_assignment_11():
    with open(r"C:/Users/stoic/OneDrive/Desktop/Python2/Tkinter Data Entry Form tutorial for beginners - Python GUI project [responsive layout].py", "r") as file:
        exec(file.read())

def run_assignment_12():
    with open(r"C:/Users/stoic/OneDrive/Desktop/Python2/Python Excel Data Entry Form with Tkinter tutorial for beginners - Python GUI project [openpyxl].py", "r") as file:
        exec(file.read())
...
# another sub menu
Some_Assignments_menu = tk.Menu(menu, tearoff = False)
Some_Assignments_menu.add_command(label="Tkinter Data Entry Form tutorial for beginners - Python GUI project [responsive layout]", command=run_assignment_11)
Some_Assignments_menu.add_command(label="Python Excel Data Entry Form with Tkinter tutorial for beginners - Python GUI project [openpyxl]", command=run_assignment_12)
Some_Assignments_menu.add_separator()
menu.add_cascade(label = '4th Set of Assignments', menu = Some_Assignments_menu)
